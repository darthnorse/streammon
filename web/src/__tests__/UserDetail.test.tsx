...
describe('UserDetail', () => {
  ...
  it('shows not found for 404 error', () => {
    ...
    mockUseFetch.mockReturnValue({ data: null, loading: false, error: err })
  ...
  it('renders user header with role badge', () => {
    mockUseFetch
      .mockReturnValueOnce({ data: baseUser, loading: false, error: null })
      .mockReturnValueOnce({ data: testHistory, loading: false, error: null })
    renderAtRoute('/users/alice')
